...
Q_IMPORT_QML_PLUGIN(QBobinkModelTesterContentPlugin)
Q_IMPORT_QML_PLUGIN(QBobinkModelTesterPlugin)

const char mainQmlFile[] = "qrc:/qt/qml/QBobinkModelTesterContent/App.qml";
